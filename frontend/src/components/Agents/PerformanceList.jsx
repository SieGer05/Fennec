      ...
      <div className="overflow-hidden mt-2">
         ...
         <div className="space-y-5">
            {performances.map(({ label, value }, index) => {
               const percentageMatch = value.match(/(\d+)\s*%/);
                     ...
                     <div className="flex-1 min-w-0">
                        ...
                        <div className="mt-2 w-full bg-gray-200 rounded-full h-1.5">
                           <div 
                              ...
                              style={{ width: `${(parseFloat(memoryMatch[1]) / parseFloat(memoryMatch[2])) * 100}%` }}
                           ></div>
                        </div>
                        )}
                        ...
                        <div className="mt-2 w-full bg-gray-200 rounded-full h-1.5">
                           <div 
                              ...
                              style={{ width: `${(parseFloat(diskMatch[1]) / parseFloat(diskMatch[2])) * 100}%` }}
                           ></div>
                        </div>
                        )}
                     </div>
